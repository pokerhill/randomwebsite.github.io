...
const OrbtosArchitecture = () => (
  <div className="relative aspect-[1442/752] w-full overflow-hidden bg-orb-black">
    {/* Blurred space plate with the design's dark wash over it. */}
    ...
    {/* ORBtos lockup */}
    <div className="absolute left-[10.19%] top-[45.12%] flex w-[13.41%] flex-col items-center gap-[7.3%] text-white">
